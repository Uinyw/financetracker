...
2. The system validates the received data. A monetary amount can only be provided if the income source is static. If the income source is dynamic, income records can be added later. One-Time income sources have to be static.
...
Information Requirements: ID, Name, Description, Category, Periodicity, One-Time or Recurring, Dynamic or Static, Monetary Amount
```
...
6. The system validates the edited data. A monetary amount can only be provided if the income source is static. If the income source is dynamic, income records can be added. One-Time income sources have to be static.
...
Information Requirements: ID, Name, Description, Category, Periodicity, Dynamic or Static, Monetary Amount, Income Records
```
